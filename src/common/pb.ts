...
class PB_GameReview$Type extends MessageType<PB_GameReview> {
    ...
    create(value?: PartialMessage<PB_GameReview>): PB_GameReview {
        const message = { gameMode: 0, playerArrangementMode: 0, userIds: [], usernames: [], hostUserId: 0, tileBag: [], gameActions: [], beginTimestamp: 0, gameActionTimestampOffsets: [], endTimestamp: 0 };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
