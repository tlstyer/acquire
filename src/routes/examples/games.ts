...
const gameJson1 = {
  ...
  hostUserId: 4,
  tileBag: [
    90, 78, 9, 60, 34, 15, 21, 64, 62, 55, 41, 8, 105, 35, 74, 59, 0, 11, 24, 101, 43, 102, 95, 10, 53, 84, 30, 83, 1, 79, 17, 70, 13, 88, 97, 23, 14, 91, 40,
    85, 29, 87, 103, 67, 2, 80, 7, 98, 99,
  ],
  gameActions: [
    { startGame: {} },
    { playTile: { tile: 9 } },
...
const gameJson2 = {
  ...
  hostUserId: 8,
  tileBag: [
    101, 10, 12, 18, 50, 39, 21, 13, 80, 6, 35, 14, 70, 36, 59, 51, 76, 74, 43, 105, 63, 95, 83, 65, 107, 33, 104, 86, 7, 8, 44, 48, 102, 93, 67, 49, 91, 98,
    57, 66, 84, 19, 52, 103, 99, 100, 5, 29, 54, 97, 92, 34, 25, 15, 27, 62, 9, 47, 58, 38, 85, 40, 11, 73, 79, 1, 22, 46, 42, 28, 89, 31, 82, 71, 64, 90, 2,
    68, 78, 69, 60, 4, 77, 53, 20, 30, 26, 56, 32, 55, 23, 17, 96, 94, 72, 81, 88, 41, 106, 37, 3, 16, 61, 75, 24, 0, 87, 45,
  ],
  gameActions: [
    { startGame: {} },
    { playTile: { tile: 12 } },
