...
function getProductionConfig(APP) {
  ...
  const externals = [
    ...
    },
    {
      module: 'react',
      global: 'React',
      entry: 'https://cdnjs.cloudflare.com/ajax/libs/react/16.8.2/umd/react.production.min.js',
    },
    {
      module: 'react-dom',
      global: 'ReactDOM',
      entry: 'https://cdnjs.cloudflare.com/ajax/libs/react-dom/16.8.2/umd/react-dom.production.min.js',
    },
  ];
  if (APP === 'index') {
    externals.push({
